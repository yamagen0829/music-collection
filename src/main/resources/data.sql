...
-- musicsテーブル
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (1, 1, 'Deep Sea', 'Negto', 'deep_sea.png', 'deep_sea.mp3', '深海をイメージしたインストロメンタル楽曲です。', 1500, 'negto@example.com');
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (2, 1, 'Wish', 'Negto', 'wish.png', 'wish.mp3', '願いを込めたインストロメンタル楽曲です。', 1000, 'negto@example.com');
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (3, 1, 'Fleur Blanche', 'Negto', 'fleur_blanche.png', 'fleur_blanche.mp3', '綺麗な花をイメージしたインストロメンタル楽曲です。', 500, 'negto@example.com');
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (4, 2, 'Breeze', 'Negto', 'breeze.png', 'breeze.mp3', 'そよ風をイメージしたインストロメンタル楽曲です。', 250, 'negto@example.com');
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (5, 4, 'Eclair', 'Negto', 'eclair.png', 'eclair.mp3', '閃光をイメージしたインストロメンタル楽曲です。', 1500, 'negto@example.com');
INSERT IGNORE INTO musics (music_id, genre_id, song_title, artist, image_name, music_file, description, price, email) VALUES (6, 3, 'Liberte', 'Negto', 'liberte.png', 'liberte.mp3', '自由をイメージしたインストロメンタル楽曲です。', 1250, 'negto@example.com');
