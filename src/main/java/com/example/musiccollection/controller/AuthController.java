...
import com.example.musiccollection.event.SignupEventPublisher;
import com.example.musiccollection.form.SignupForm;
import com.example.musiccollection.service.UserService;
import com.example.musiccollection.service.VerificationTokenService;
...
public class AuthController {
    ...
    public String signup(@ModelAttribute @Validated SignupForm signupForm, BindingResult bindingResult, RedirectAttributes redirectAttributes, HttpServletRequest httpServletRequest) {
    	...
    	if (userService.isEmailRegistered(signupForm.getUserEmail())) {
