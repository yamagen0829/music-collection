      ...
      //価格データを価格の繰り返し情報で設定
      	SessionCreateParams.LineItem.PriceData priceData = SessionCreateParams.LineItem.PriceData.builder()
      		     .setProductData(SessionCreateParams.LineItem.PriceData.ProductData.builder()
      						.setName("Musiccollection有料会員").build())
      		     .setUnitAmount(300L)
      			 .setCurrency("jpy")
        ...
        SessionCreateParams params =
            ...
            System.out.println("StripeService :" + session.getId());
 ...
 // セッションからユーザー情報を取得し、UserServiceクラスを介してデータベースに登録する 
    public void processSessionCompleted(Event event) {
    	...
    	if (optionalStripeObject.isPresent()) {
            ...
            User user = userService.findByUserEmail(session.getCustomerDetails().getEmail());
